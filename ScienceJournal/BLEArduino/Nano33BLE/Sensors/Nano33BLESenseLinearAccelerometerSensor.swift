//
//  Nano33BLESenseLinearAccelerometerSensor.swift
//  ScienceJournal
//
...
struct Nano33BLESenseLinearAccelerometerSensor: BLEArduinoSensor {
  static var uuid: CBUUID { CBUUID(string: "555a0002-0011-467a-9538-01f0652c74e8") }

  var name: String { "linear_accelerometer".localized }

  var iconName: String { "ic_sensor_acc_linear" }
  
  var filledIconName: String { "ic_sensor_acc_linear_filled" }
