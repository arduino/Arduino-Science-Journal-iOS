...
class ExportExperimentSensorDataOperationTest: XCTestCase {
  ...
  func testSensorDataProtoFromExperiment() {
    ...
    let sensor1 = SensorLayout(sensorID: "Sensor_1", colorPalette: ArduinoColorPalette.defaultPalette)
    let sensor2 = SensorLayout(sensorID: "Sensor_2", colorPalette: ArduinoColorPalette.defaultPalette)
    let sensor3 = SensorLayout(sensorID: "Sensor_3", colorPalette: ArduinoColorPalette.defaultPalette)
