...
class ExperimentDataParserTest: XCTestCase {
  ...
  func setupTrial() {
    ...
    // Layouts.
    let sensorLayout1 = SensorLayout(sensorID: sensor1.sensorId, colorPalette: ArduinoColorPalette.defaultPalette)
    trial.sensorLayouts.append(sensorLayout1)

    let sensorLayout2 = SensorLayout(sensorID: sensor2.sensorId, colorPalette: ArduinoColorPalette.defaultPalette)
