...
@testable import MaterialComponents.MaterialPalettes
...
class SensorLayoutTest: XCTestCase {
  ...
  func testProtoInput() {
    ...
    XCTAssertEqual(ArduinoColorPalette.tealPalette, sensorLayout.colorPalette)
  ...
  func testProtoOutput() {
    let sensorLayout = SensorLayout(sensorID: "456DEF", colorPalette: ArduinoColorPalette.goldPalette)
  ...
  func testActiveSensorTriggers() {
    let sensorLayout = SensorLayout(sensorID: "test sensor ID", colorPalette: ArduinoColorPalette.defaultPalette)
    sensorLayout.activeSensorTriggerIDs = ["A", "B", "C"]
  ...
  func testEquality() {
    let sensorLayout1 = SensorLayout(sensorID: "SENSOR 1", colorPalette: ArduinoColorPalette.defaultPalette)
    ...
    let sensorLayout2 = SensorLayout(sensorID: "SENSOR 1", colorPalette: ArduinoColorPalette.defaultPalette)
    ...
    let sensorLayout3 = SensorLayout(sensorID: "SENSOR 2", colorPalette: ArduinoColorPalette.defaultPalette)
