...
class ExperimentTest: XCTestCase {
  ...
  func testSensorLayoutForSensorID() {
    ...
    let sensorLayout1 = SensorLayout(sensorID: sensorID, colorPalette: ArduinoColorPalette.defaultPalette)
    let sensorLayout2 = SensorLayout(sensorID: "another sensor", colorPalette: ArduinoColorPalette.defaultPalette)
  ...
  func testRemoveSensorLayouts() {
    ...
    let sensorLayout1 = SensorLayout(sensorID: "SENSOR_LAYOUT_1", colorPalette: ArduinoColorPalette.defaultPalette)
    let sensorLayout2 = SensorLayout(sensorID: "SENSOR_LAYOUT_2", colorPalette: ArduinoColorPalette.defaultPalette)
    let sensorLayout3 = SensorLayout(sensorID: "SENSOR_LAYOUT_3", colorPalette: ArduinoColorPalette.defaultPalette)
