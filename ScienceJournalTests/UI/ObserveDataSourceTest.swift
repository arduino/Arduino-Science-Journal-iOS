...
class ObserveDataSourceTest: XCTestCase {
  ...
  func testSensorCardForSensor() {
    ...
    let sensorCard1 = SensorCard(sensor: sensor1, colorPalette: ArduinoColorPalette.defaultPalette)
    let sensorCard2 = SensorCard(sensor: sensor2, colorPalette: ArduinoColorPalette.defaultPalette)
